          ...
          <div className="about-details">
            ...
            <div className="about-subsection">
              ...
              <p className="italics-thin">
                ...
                <span className="italics-bold">Brown University (2024)</span>
              </p>
              <p className="italics-thin">
                B.F.A Film/Animation/Video @{" "}
            ...
            <div className="about-subsection">
              ...
              <p className="italics-thin">
                ...
                <span className="italics-bold">Tesla</span>
              </p>
              <p className="italics-thin">
                Research Engineer @{" "}
                <span className="italics-bold">Brown HCI</span>
              </p>
              <p className="italics-thin">
                UX Engineering Intern @{" "}
                <span className="italics-bold">BMW</span>
              </p>
              <p className="italics-thin">
                Technical Director Intern @{" "}
                <span className="italics-bold">Pixar</span>
              </p>
              <p className="italics-thin">
                VR Software Engineering Intern @{" "}
                <span className="italics-bold">Bayer</span>
              </p>
              <p className="italics-thin">
                AR Developer @ <span className="italics-bold">NASA</span>
              </p>
            </div>
